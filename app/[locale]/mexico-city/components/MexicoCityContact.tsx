...
export default function MexicoCityContact() {
  const t = useTranslations('mexicoCity');
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append('source', 'mexico-city');
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg font-light">
            Cuéntanos sobre tu proyecto en CDMX y te respondemos en menos de 24 horas
          </p>
        ...
        >
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            {result && <span className="block text-center text-sm text-gray-300">{result}</span>}
          </form>
