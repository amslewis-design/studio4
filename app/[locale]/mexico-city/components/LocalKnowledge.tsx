...
export default function LocalKnowledge() {
  const t = useTranslations('mexicoCity.localKnowledge');
          ...
          <div className="space-y-8">
            ...
            >
              <p className="text-[#D4AF37] text-sm italic">
                &ldquo;Crear contenido en CDMX requiere entender el ritmo, la luz y la identidad de cada zona.
                Esa precisión local es la diferencia entre verse bien y destacar.&rdquo;
              </p>
            </motion.div>
          </div>
        </div>
