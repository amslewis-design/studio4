...
export default function LocalKnowledge() {
  const t = useTranslations('cuernavaca.localKnowledge');
          ...
          <div className="space-y-8">
            ...
            >
              <p className="text-[#D4AF37] text-sm italic">
                &ldquo;Trabajar en Cuernavaca requiere entender su ritmo, su luz y su estacionalidad.
                Esa lectura local es clave para contenido que sí conecta y convierte.&rdquo;
              </p>
            </motion.div>
          </div>
        </div>
