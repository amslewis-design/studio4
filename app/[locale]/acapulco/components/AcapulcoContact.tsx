...
export default function AcapulcoContact() {
  const t = useTranslations('acapulco');
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append('source', 'acapulco');
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg font-light">
            Cuéntanos sobre tu proyecto en Acapulco y te respondemos en menos de 24 horas
          </p>
